	...
	return (
		<div>
			...
			<section className="bg-blue-950 text-white py-20">
				<div className="px-64">
					<h2 className="text-4xl font-bold text-center mb-12 leading-normal">What People Are Saying<br />About Our Dental Clinic</h2>
			...
			<section className="bg-white py-16 border-t border-gray-100">
				<div className="px-64 flex items-center justify-between">
					<div>
						<h2 className="text-3xl font-bold text-blue-950 mb-2">Ready to book your appointment?</h2>
